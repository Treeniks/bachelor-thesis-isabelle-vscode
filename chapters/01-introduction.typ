...
In 1911, Alwin Korselt @intro-korselt1911 showed that Ernst Schröder's proof of the Cantor-Bernstein-Schröder theorem, originally published in 1898 @intro-schroder1898, contained an error. While the theorem was correct, and other proofs of this theorem existed even back then @intro-dedekind1887[p.~447-449], this isn't the only instance where mathematicians tried to proof a statement, thought they conceived such proof and later found that the proof was incorrect or incomplete. Thus, there exist software tools called proof assistants which allow one to formalize mathematical proofs and have the computer check for the proof's correctness. One such tool is _Isabelle_ #footnote[https://isabelle.in.tum.de/], originally developed at the _University of Cambridge_ and _Technical University of Munich_.
